import media # import the self written media library
import fresh_tomatoes # import the provided fresh_tomatoes lib that generates the html/css code for the provided movie classes
...
black_panther = media.Movie("Black Panther",
                           "T'Challa, the King of Wakanda, rises to the throne in the isolated, technologically advanced African nation,"
                            " but his claim is challenged by a vengeful outsider who was a childhood victim of T'Challa's father's mistake.",
...
walter_mitty = media.Movie("The Secret Life of Walter Mitty",
                           "When his job along with that of his co-worker are threatened, Walter takes action # NOQAin the real world "
                           "embarking on a global journey that turns into an adventure more extraordinary than anything he could have ever imagined.",
                           "https://images-na.ssl-images-amazon.com/images/M/MV5BODYwNDYxNDk1Nl5BMl5BanBnXkFtZTgwOTAwMTk2MDE@._V1_UX182_CR0,0,182,268_AL_.jpg",
                           "https://www.youtube.com/watch?v=HddkucqSzSM",
                           114)# movie instance made for The Secret Life of Walter Mitty.
...
good_will_hunting = media.Movie("Good Will Hunting",
                           ...
                           "https://images-na.ssl-images-amazon.com/images/M/MV5BOTI0MzcxMTYtZDVkMy00NjY1LTgyMTYtZmUxN2M3NmQ2NWJhXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_UX182_CR0,0,182,268_AL_.jpg",
                           "https://www.youtube.com/watch?v=ReIJ1lbL-Q8",
                           126)# movie instance made for Good Will Hunting.



movies = [toy_story,avatar, interstellar, black_panther, walter_mitty, good_will_hunting] #Array of movie instances/objects

fresh_tomatoes.open_movies_page(movies) # Call the open_movies_page function from the fresh_tomatoes lib. Provide it with the movies array.
